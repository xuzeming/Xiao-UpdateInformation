...
cc.push("<span class=\"tree-title\"></span>");
cc.push("<span class=\"tree-icon tree-folder "+(item.iconCls?item.iconCls:"")+"\"></span>");
}else{
if(item.children&&item.children.length){
cc.push("<span class=\"tree-hit tree-expanded\">"+opts.formatter.call(_19d,item).substr(1)+"</span>");   //改了
cc.push("<span class=\"tree-title\"></span>");
...
var myStr = opts.formatter.call(_19d,item).substr(0,1);
if(myStr !='1'){
cc.push("<span class=\"tree-title\">"+opts.formatter.call(_19d,item)+"</span>");  //前端写的SPAN  传进来的字符串
}
cc.push("</div>");
if(item.children&&item.children.length){
